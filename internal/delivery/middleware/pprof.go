...
// RegisterPPROF the standard Handler Func from the net/http/pprof package with
// the provided gin.Engine. prefixOptions is an optional. If not prefixOptions,
// the default path prefix is used, otherwise first prefixOptions will be path prefix.
func RegisterPPROF(r *gin.Engine, prefixOptions ...string) {
	RouteRegister(&(r.RouterGroup), prefixOptions...)
}

// RouteRegister the standard HandlerFunc from the net/http/pprof package with
// the provided gin.RouterGroup. prefixOptions is an optional. If not prefixOptions,
// the default path prefix is used, otherwise first prefixOptions will be path prefix.
